            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-3 bg-white border border-gray-350 rounded-2xl text-xs font-semibold text-gray-800 placeholder-gray-400 focus:border-red-500 focus:ring-1 focus:ring-red-500/20 outline-none transition-all duration-150"
                  disabled={loading}
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-4 top-1/2 -translate-y-1/2 flex items-center justify-center cursor-pointer text-gray-400 hover:text-red-650 focus:outline-none"
                >
                  {showPassword ? (
